...
const GROUP_MATCHES = [
  ...
  { id: 'C1', group: 'C', matchday: 1, teamA: 'Brazil', teamB: 'Morocco', venue: 'New York New Jersey Stadium', city: 'New York/New Jersey', date: '2026-06-13', timeET: '18:00', timeKansas: '17:00', timeCDMX: '16:00', preResult: [1, 1] },
  { id: 'C2', group: 'C', matchday: 1, teamA: 'Haiti', teamB: 'Scotland', venue: 'Boston Stadium', city: 'Boston', date: '2026-06-13', timeET: '21:00', timeKansas: '20:00', timeCDMX: '19:00', preResult: [0, 1] },
  { id: 'D2', group: 'D', matchday: 1, teamA: 'Australia', teamB: 'Türkiye', venue: 'BC Place Vancouver', city: 'Vancouver', date: '2026-06-13', timeET: '00:00', timeKansas: '23:00', timeCDMX: '22:00', preResult: [2, 0] },
  // Domingo 14 junio
  { id: 'E1', group: 'E', matchday: 1, teamA: 'Germany', teamB: 'Curaçao', venue: 'Houston Stadium', city: 'Houston', date: '2026-06-14', timeET: '13:00', timeKansas: '12:00', timeCDMX: '11:00', preResult: [7, 1] },
  { id: 'F1', group: 'F', matchday: 1, teamA: 'Netherlands', teamB: 'Japan', venue: 'Dallas Stadium', city: 'Dallas', date: '2026-06-14', timeET: '16:00', timeKansas: '15:00', timeCDMX: '14:00', preResult: [2, 2] },
  { id: 'E2', group: 'E', matchday: 1, teamA: 'Ivory Coast', teamB: 'Ecuador', venue: 'Philadelphia Stadium', city: 'Philadelphia', date: '2026-06-14', timeET: '19:00', timeKansas: '18:00', timeCDMX: '17:00', preResult: [1, 0] },
  { id: 'F2', group: 'F', matchday: 1, teamA: 'Sweden', teamB: 'Tunisia', venue: 'Estadio Monterrey', city: 'Monterrey', date: '2026-06-14', timeET: '22:00', timeKansas: '21:00', timeCDMX: '20:00', preResult: [5, 1] },
  // Lunes 15 junio
  { id: 'H1', group: 'H', matchday: 1, teamA: 'Spain', teamB: 'Cape Verde', venue: 'Atlanta Stadium', city: 'Atlanta', date: '2026-06-15', timeET: '12:00', timeKansas: '11:00', timeCDMX: '10:00', preResult: [0, 0] },
  { id: 'G1', group: 'G', matchday: 1, teamA: 'Belgium', teamB: 'Egypt', venue: 'Seattle Stadium', city: 'Seattle', date: '2026-06-15', timeET: '15:00', timeKansas: '14:00', timeCDMX: '13:00', preResult: [1, 1] },
  { id: 'H2', group: 'H', matchday: 1, teamA: 'Saudi Arabia', teamB: 'Uruguay', venue: 'Miami Stadium', city: 'Miami', date: '2026-06-15', timeET: '18:00', timeKansas: '17:00', timeCDMX: '16:00', preResult: [1, 1] },
  { id: 'G2', group: 'G', matchday: 1, teamA: 'Iran', teamB: 'New Zealand', venue: 'Los Angeles Stadium', city: 'Los Angeles', date: '2026-06-15', timeET: '21:00', timeKansas: '20:00', timeCDMX: '19:00', preResult: [2, 2] },
  // Martes 16 junio
  { id: 'I1', group: 'I', matchday: 1, teamA: 'France', teamB: 'Senegal', venue: 'New York New Jersey Stadium', city: 'New York/New Jersey', date: '2026-06-16', timeET: '15:00', timeKansas: '14:00', timeCDMX: '13:00', preResult: [3, 1] },
  { id: 'I2', group: 'I', matchday: 1, teamA: 'Iraq', teamB: 'Norway', venue: 'Boston Stadium', city: 'Boston', date: '2026-06-16', timeET: '18:00', timeKansas: '17:00', timeCDMX: '16:00', preResult: [1, 4] },
  { id: 'J1', group: 'J', matchday: 1, teamA: 'Argentina', teamB: 'Algeria', venue: 'Kansas City Stadium', city: 'Kansas City', date: '2026-06-16', timeET: '21:00', timeKansas: '20:00', timeCDMX: '19:00', preResult: [3, 0] },
  { id: 'J2', group: 'J', matchday: 1, teamA: 'Austria', teamB: 'Jordan', venue: 'San Francisco Bay Area Stadium', city: 'San Francisco Bay Area', date: '2026-06-16', timeET: '00:00', timeKansas: '23:00', timeCDMX: '22:00', preResult: [3, 1] },
  // Miércoles 17 junio
  { id: 'K1', group: 'K', matchday: 1, teamA: 'Portugal', teamB: 'Congo DR', venue: 'Houston Stadium', city: 'Houston', date: '2026-06-17', timeET: '13:00', timeKansas: '12:00', timeCDMX: '11:00', preResult: null },
  { id: 'L1', group: 'L', matchday: 1, teamA: 'England', teamB: 'Croatia', venue: 'Dallas Stadium', city: 'Dallas', date: '2026-06-17', timeET: '16:00', timeKansas: '15:00', timeCDMX: '14:00', preResult: null },
  { id: 'L2', group: 'L', matchday: 1, teamA: 'Ghana', teamB: 'Panama', venue: 'Toronto Stadium', city: 'Toronto', date: '2026-06-17', timeET: '19:00', timeKansas: '18:00', timeCDMX: '17:00', preResult: null },
  { id: 'K2', group: 'K', matchday: 1, teamA: 'Uzbekistan', teamB: 'Colombia', venue: 'Estadio Ciudad de México', city: 'Ciudad de México', date: '2026-06-17', timeET: '22:00', timeKansas: '21:00', timeCDMX: '20:00', preResult: null },
  // Jueves 18 junio
  { id: 'A3', group: 'A', matchday: 2, teamA: 'Czechia', teamB: 'South Africa', venue: 'Atlanta Stadium', city: 'Atlanta', date: '2026-06-18', timeET: '12:00', timeKansas: '11:00', timeCDMX: '10:00', preResult: null },
  { id: 'B3', group: 'B', matchday: 2, teamA: 'Switzerland', teamB: 'Bosnia & Herzegovina', venue: 'Los Angeles Stadium', city: 'Los Angeles', date: '2026-06-18', timeET: '15:00', timeKansas: '14:00', timeCDMX: '13:00', preResult: null },
  { id: 'B4', group: 'B', matchday: 2, teamA: 'Canada', teamB: 'Qatar', venue: 'BC Place Vancouver', city: 'Vancouver', date: '2026-06-18', timeET: '18:00', timeKansas: '17:00', timeCDMX: '16:00', preResult: null },
  { id: 'A4', group: 'A', matchday: 2, teamA: 'Mexico', teamB: 'South Korea', venue: 'Estadio Guadalajara', city: 'Guadalajara', date: '2026-06-18', timeET: '21:00', timeKansas: '20:00', timeCDMX: '19:00', preResult: null },
  // Viernes 19 junio
  { id: 'D3', group: 'D', matchday: 2, teamA: 'USA', teamB: 'Australia', venue: 'Seattle Stadium', city: 'Seattle', date: '2026-06-19', timeET: '15:00', timeKansas: '14:00', timeCDMX: '13:00', preResult: null },
  { id: 'C3', group: 'C', matchday: 2, teamA: 'Scotland', teamB: 'Morocco', venue: 'Boston Stadium', city: 'Boston', date: '2026-06-19', timeET: '18:00', timeKansas: '17:00', timeCDMX: '16:00', preResult: null },
  { id: 'C4', group: 'C', matchday: 2, teamA: 'Brazil', teamB: 'Haiti', venue: 'Philadelphia Stadium', city: 'Philadelphia', date: '2026-06-19', timeET: '21:00', timeKansas: '20:00', timeCDMX: '19:00', preResult: null },
  { id: 'D4', group: 'D', matchday: 2, teamA: 'Türkiye', teamB: 'Paraguay', venue: 'San Francisco Bay Area Stadium', city: 'San Francisco Bay Area', date: '2026-06-19', timeET: '00:00', timeKansas: '23:00', timeCDMX: '22:00', preResult: null },
  // Sábado 20 junio
  ...
  { id: 'G3', group: 'G', matchday: 2, teamA: 'Belgium', teamB: 'Iran', venue: 'Los Angeles Stadium', city: 'Los Angeles', date: '2026-06-21', timeET: '15:00', timeKansas: '14:00', timeCDMX: '13:00', preResult: null },
  { id: 'H4', group: 'H', matchday: 2, teamA: 'Uruguay', teamB: 'Cape Verde', venue: 'Miami Stadium', city: 'Miami', date: '2026-06-21', timeET: '18:00', timeKansas: '17:00', timeCDMX: '16:00', preResult: null },
  { id: 'G4', group: 'G', matchday: 2, teamA: 'New Zealand', teamB: 'Egypt', venue: 'BC Place Vancouver', city: 'Vancouver', date: '2026-06-21', timeET: '21:00', timeKansas: '20:00', timeCDMX: '19:00', preResult: null },
  // Lunes 22 junio
  { id: 'J3', group: 'J', matchday: 2, teamA: 'Argentina', teamB: 'Austria', venue: 'Dallas Stadium', city: 'Dallas', date: '2026-06-22', timeET: '13:00', timeKansas: '12:00', timeCDMX: '11:00', preResult: null },
  { id: 'I3', group: 'I', matchday: 2, teamA: 'France', teamB: 'Iraq', venue: 'Philadelphia Stadium', city: 'Philadelphia', date: '2026-06-22', timeET: '17:00', timeKansas: '16:00', timeCDMX: '15:00', preResult: null },
  { id: 'I4', group: 'I', matchday: 2, teamA: 'Norway', teamB: 'Senegal', venue: 'New York New Jersey Stadium', city: 'New York/New Jersey', date: '2026-06-22', timeET: '20:00', timeKansas: '19:00', timeCDMX: '18:00', preResult: null },
  { id: 'J4', group: 'J', matchday: 2, teamA: 'Jordan', teamB: 'Algeria', venue: 'San Francisco Bay Area Stadium', city: 'San Francisco Bay Area', date: '2026-06-22', timeET: '23:00', timeKansas: '22:00', timeCDMX: '21:00', preResult: null },
  // Martes 23 junio
  { id: 'K3', group: 'K', matchday: 2, teamA: 'Portugal', teamB: 'Uzbekistan', venue: 'Houston Stadium', city: 'Houston', date: '2026-06-23', timeET: '13:00', timeKansas: '12:00', timeCDMX: '11:00', preResult: null },
  { id: 'L3', group: 'L', matchday: 2, teamA: 'England', teamB: 'Ghana', venue: 'Boston Stadium', city: 'Boston', date: '2026-06-23', timeET: '16:00', timeKansas: '15:00', timeCDMX: '14:00', preResult: null },
  { id: 'L4', group: 'L', matchday: 2, teamA: 'Panama', teamB: 'Croatia', venue: 'Toronto Stadium', city: 'Toronto', date: '2026-06-23', timeET: '19:00', timeKansas: '18:00', timeCDMX: '17:00', preResult: null },
  { id: 'K4', group: 'K', matchday: 2, teamA: 'Colombia', teamB: 'Congo DR', venue: 'Estadio Guadalajara', city: 'Guadalajara', date: '2026-06-23', timeET: '22:00', timeKansas: '21:00', timeCDMX: '20:00', preResult: null },
  // Miércoles 24 junio
  { id: 'B5', group: 'B', matchday: 3, teamA: 'Switzerland', teamB: 'Canada', venue: 'BC Place Vancouver', city: 'Vancouver', date: '2026-06-24', timeET: '15:00', timeKansas: '14:00', timeCDMX: '13:00', preResult: null },
  { id: 'B6', group: 'B', matchday: 3, teamA: 'Bosnia & Herzegovina', teamB: 'Qatar', venue: 'Seattle Stadium', city: 'Seattle', date: '2026-06-24', timeET: '15:00', timeKansas: '14:00', timeCDMX: '13:00', preResult: null },
  { id: 'C5', group: 'C', matchday: 3, teamA: 'Scotland', teamB: 'Brazil', venue: 'Miami Stadium', city: 'Miami', date: '2026-06-24', timeET: '18:00', timeKansas: '17:00', timeCDMX: '16:00', preResult: null },
  { id: 'C6', group: 'C', matchday: 3, teamA: 'Morocco', teamB: 'Haiti', venue: 'Atlanta Stadium', city: 'Atlanta', date: '2026-06-24', timeET: '18:00', timeKansas: '17:00', timeCDMX: '16:00', preResult: null },
  { id: 'A5', group: 'A', matchday: 3, teamA: 'Czechia', teamB: 'Mexico', venue: 'Estadio Ciudad de México', city: 'Ciudad de México', date: '2026-06-24', timeET: '21:00', timeKansas: '20:00', timeCDMX: '19:00', preResult: null },
  { id: 'A6', group: 'A', matchday: 3, teamA: 'South Africa', teamB: 'South Korea', venue: 'Estadio Monterrey', city: 'Monterrey', date: '2026-06-24', timeET: '21:00', timeKansas: '20:00', timeCDMX: '19:00', preResult: null },
  // Jueves 25 junio
  { id: 'E5', group: 'E', matchday: 3, teamA: 'Curaçao', teamB: 'Ivory Coast', venue: 'Philadelphia Stadium', city: 'Philadelphia', date: '2026-06-25', timeET: '16:00', timeKansas: '15:00', timeCDMX: '14:00', preResult: null },
  { id: 'E6', group: 'E', matchday: 3, teamA: 'Ecuador', teamB: 'Germany', venue: 'New York New Jersey Stadium', city: 'New York/New Jersey', date: '2026-06-25', timeET: '16:00', timeKansas: '15:00', timeCDMX: '14:00', preResult: null },
  { id: 'F5', group: 'F', matchday: 3, teamA: 'Japan', teamB: 'Sweden', venue: 'Dallas Stadium', city: 'Dallas', date: '2026-06-25', timeET: '19:00', timeKansas: '18:00', timeCDMX: '17:00', preResult: null },
  { id: 'F6', group: 'F', matchday: 3, teamA: 'Tunisia', teamB: 'Netherlands', venue: 'Kansas City Stadium', city: 'Kansas City', date: '2026-06-25', timeET: '19:00', timeKansas: '18:00', timeCDMX: '17:00', preResult: null },
  { id: 'D5', group: 'D', matchday: 3, teamA: 'Türkiye', teamB: 'USA', venue: 'Los Angeles Stadium', city: 'Los Angeles', date: '2026-06-25', timeET: '22:00', timeKansas: '21:00', timeCDMX: '20:00', preResult: null },
  { id: 'D6', group: 'D', matchday: 3, teamA: 'Paraguay', teamB: 'Australia', venue: 'San Francisco Bay Area Stadium', city: 'San Francisco Bay Area', date: '2026-06-25', timeET: '22:00', timeKansas: '21:00', timeCDMX: '20:00', preResult: null },
  // Viernes 26 junio
  { id: 'I5', group: 'I', matchday: 3, teamA: 'Norway', teamB: 'France', venue: 'Boston Stadium', city: 'Boston', date: '2026-06-26', timeET: '15:00', timeKansas: '14:00', timeCDMX: '13:00', preResult: null },
  { id: 'I6', group: 'I', matchday: 3, teamA: 'Senegal', teamB: 'Iraq', venue: 'Toronto Stadium', city: 'Toronto', date: '2026-06-26', timeET: '15:00', timeKansas: '14:00', timeCDMX: '13:00', preResult: null },
  { id: 'H5', group: 'H', matchday: 3, teamA: 'Cape Verde', teamB: 'Saudi Arabia', venue: 'Houston Stadium', city: 'Houston', date: '2026-06-26', timeET: '20:00', timeKansas: '19:00', timeCDMX: '18:00', preResult: null },
  { id: 'H6', group: 'H', matchday: 3, teamA: 'Uruguay', teamB: 'Spain', venue: 'Estadio Guadalajara', city: 'Guadalajara', date: '2026-06-26', timeET: '20:00', timeKansas: '19:00', timeCDMX: '18:00', preResult: null },
  { id: 'G5', group: 'G', matchday: 3, teamA: 'Egypt', teamB: 'Iran', venue: 'Seattle Stadium', city: 'Seattle', date: '2026-06-26', timeET: '23:00', timeKansas: '22:00', timeCDMX: '21:00', preResult: null },
  { id: 'G6', group: 'G', matchday: 3, teamA: 'New Zealand', teamB: 'Belgium', venue: 'BC Place Vancouver', city: 'Vancouver', date: '2026-06-26', timeET: '23:00', timeKansas: '22:00', timeCDMX: '21:00', preResult: null },
  // Sábado 27 junio
  { id: 'L5', group: 'L', matchday: 3, teamA: 'Panama', teamB: 'England', venue: 'New York New Jersey Stadium', city: 'New York/New Jersey', date: '2026-06-27', timeET: '17:00', timeKansas: '16:00', timeCDMX: '15:00', preResult: null },
  { id: 'L6', group: 'L', matchday: 3, teamA: 'Croatia', teamB: 'Ghana', venue: 'Philadelphia Stadium', city: 'Philadelphia', date: '2026-06-27', timeET: '17:00', timeKansas: '16:00', timeCDMX: '15:00', preResult: null },
  { id: 'K5', group: 'K', matchday: 3, teamA: 'Colombia', teamB: 'Portugal', venue: 'Miami Stadium', city: 'Miami', date: '2026-06-27', timeET: '19:30', timeKansas: '18:30', timeCDMX: '17:30', preResult: null },
  { id: 'K6', group: 'K', matchday: 3, teamA: 'Congo DR', teamB: 'Uzbekistan', venue: 'Atlanta Stadium', city: 'Atlanta', date: '2026-06-27', timeET: '19:30', timeKansas: '18:30', timeCDMX: '17:30', preResult: null },
  { id: 'J5', group: 'J', matchday: 3, teamA: 'Algeria', teamB: 'Austria', venue: 'Kansas City Stadium', city: 'Kansas City', date: '2026-06-27', timeET: '22:00', timeKansas: '21:00', timeCDMX: '20:00', preResult: null },
  { id: 'J6', group: 'J', matchday: 3, teamA: 'Jordan', teamB: 'Argentina', venue: 'Dallas Stadium', city: 'Dallas', date: '2026-06-27', timeET: '22:00', timeKansas: '21:00', timeCDMX: '20:00', preResult: null },
];
