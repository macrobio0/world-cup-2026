...
const GROUP_MATCHES = [
  ...
  // Miércoles 17 junio
  { id: 'K1', group: 'K', matchday: 1, teamA: 'Portugal', teamB: 'Congo DR', venue: 'Houston Stadium', city: 'Houston', date: '2026-06-17', timeET: '13:00', timeKansas: '12:00', timeCDMX: '11:00', preResult: [1, 1] },
  { id: 'L1', group: 'L', matchday: 1, teamA: 'England', teamB: 'Croatia', venue: 'Dallas Stadium', city: 'Dallas', date: '2026-06-17', timeET: '16:00', timeKansas: '15:00', timeCDMX: '14:00', preResult: [4, 2] },
  { id: 'L2', group: 'L', matchday: 1, teamA: 'Ghana', teamB: 'Panama', venue: 'Toronto Stadium', city: 'Toronto', date: '2026-06-17', timeET: '19:00', timeKansas: '18:00', timeCDMX: '17:00', preResult: [1, 0] },
  { id: 'K2', group: 'K', matchday: 1, teamA: 'Uzbekistan', teamB: 'Colombia', venue: 'Estadio Ciudad de México', city: 'Ciudad de México', date: '2026-06-17', timeET: '22:00', timeKansas: '21:00', timeCDMX: '20:00', preResult: [1, 3] },
  // Jueves 18 junio
  { id: 'A3', group: 'A', matchday: 2, teamA: 'Czechia', teamB: 'South Africa', venue: 'Atlanta Stadium', city: 'Atlanta', date: '2026-06-18', timeET: '12:00', timeKansas: '11:00', timeCDMX: '10:00', preResult: [1, 1] },
  { id: 'B3', group: 'B', matchday: 2, teamA: 'Switzerland', teamB: 'Bosnia & Herzegovina', venue: 'Los Angeles Stadium', city: 'Los Angeles', date: '2026-06-18', timeET: '15:00', timeKansas: '14:00', timeCDMX: '13:00', preResult: [4, 1] },
  { id: 'B4', group: 'B', matchday: 2, teamA: 'Canada', teamB: 'Qatar', venue: 'BC Place Vancouver', city: 'Vancouver', date: '2026-06-18', timeET: '18:00', timeKansas: '17:00', timeCDMX: '16:00', preResult: [6, 0] },
  { id: 'A4', group: 'A', matchday: 2, teamA: 'Mexico', teamB: 'South Korea', venue: 'Estadio Guadalajara', city: 'Guadalajara', date: '2026-06-18', timeET: '21:00', timeKansas: '20:00', timeCDMX: '19:00', preResult: [1, 0] },
  // Viernes 19 junio
  { id: 'D3', group: 'D', matchday: 2, teamA: 'USA', teamB: 'Australia', venue: 'Seattle Stadium', city: 'Seattle', date: '2026-06-19', timeET: '15:00', timeKansas: '14:00', timeCDMX: '13:00', preResult: [2, 0] },
  { id: 'C3', group: 'C', matchday: 2, teamA: 'Scotland', teamB: 'Morocco', venue: 'Boston Stadium', city: 'Boston', date: '2026-06-19', timeET: '18:00', timeKansas: '17:00', timeCDMX: '16:00', preResult: [0, 1] },
  { id: 'C4', group: 'C', matchday: 2, teamA: 'Brazil', teamB: 'Haiti', venue: 'Philadelphia Stadium', city: 'Philadelphia', date: '2026-06-19', timeET: '21:00', timeKansas: '20:00', timeCDMX: '19:00', preResult: [3, 0] },
  { id: 'D4', group: 'D', matchday: 2, teamA: 'Türkiye', teamB: 'Paraguay', venue: 'San Francisco Bay Area Stadium', city: 'San Francisco Bay Area', date: '2026-06-19', timeET: '00:00', timeKansas: '23:00', timeCDMX: '22:00', preResult: [0, 1] },
  // Sábado 20 junio
